...
- Desktop (≥1100px): трёхколоночный layout. Центральная колонка — «Сводка смен» над «Календарём смен»; правая колонка — прогресс по договору; левая колонка — быстрые переходы, план работ, заявления. Сетка карточек адаптивна (до 4 в ряд).
- Mobile/Tablet: вертикальный список карточек в порядке: KPI → открытая смена → быстрые действия → «Сводка смен» → «Календарь смен» → «Прогресс договора» → «План работ» → «Заявления». Календарь и прогресс по договору — отдельные карточки.
