...
⚠️ **Примечание (15 января 2025):** Модуль выгрузки (Export) был полностью удален. Модуль поиска (Search) имеет самостоятельную реализацию. Этот документ сохранен как историческая справка.
