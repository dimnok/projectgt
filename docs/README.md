...
3. [Система аутентификации и профилей](auth_system.md) - аутентификация, авторизация, структура пользовательских данных и рабочий процесс регистрации/входа.
...
- **usecases/** — UseCase для бизнес-операций (CRUD, авторизация и др.), разбиты по сущностям.
  - **auth/** — UseCase для аутентификации (логин, логаут, регистрация, получение текущего пользователя).
