...
| **Заявки на закупку** | [`purchase_requests/purchase_requests_module.md`](./purchase_requests/purchase_requests_module.md) | Workflow заявок: согласование, счета, оплата, получение |
