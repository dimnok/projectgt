...
**Изменения 10.09.2026:**
- Веб-профиль не использует FIFO. Сводка месяца без выплат. Списки премий, штрафов и выплат в профиле — все записи текущего сотрудника за всё время. RPC `get_my_profile_finance`. Канон экрана: [`react_app/docs/profile.md`](../../react_app/docs/profile.md).
