## Уведомления в ProjectGT

### Два типа уведомлений

| Тип | Когда | Документация |
|-----|-------|--------------|
| **Локальные напоминания** | Слоты времени после открытия смены (iOS/Android native) | этот файл |
| **Push админам / владельцам** | Открытие и закрытие смены (FCM, включая PWA iPhone) | [admin_notifications.md](./admin_notifications.md) |

---

## Локальные уведомления (iOS/Android)
