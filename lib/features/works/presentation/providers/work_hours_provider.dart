...
class WorkHoursNotifier extends StateNotifier<AsyncValue<List<WorkHour>>> {
  ...
  WorkHoursNotifier(this.repository, this.workId) : super(const AsyncValue.loading()) {
    fetch();
  }
...
final workHoursProvider = StateNotifierProvider.family<WorkHoursNotifier, AsyncValue<List<WorkHour>>, String>((ref, workId) {
