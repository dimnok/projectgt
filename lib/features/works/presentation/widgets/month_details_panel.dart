...
class _MonthDetailsPanelState extends ConsumerState<MonthDetailsPanel> {
          ...
          : SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                    ...
                    children: [
                      ...
                      Expanded(
                        child: _buildStatCard(
                          ...
                          label: 'Общая сумма',
                          value:
                              '${formatter.format(currentGroup.totalAmount)} ₽',
                          color: Colors.green,
                          isCompact: true,
                        ),
                      ),
                    ...
                    children: [
                      Expanded(
                        child: _buildStatCard(
                          ...
                          value: currentGroup.worksCount > 0
                              ? '${formatter.format(currentGroup.totalAmount / currentGroup.worksCount)} ₽'
                              : '0 ₽',
                          color: Colors.orange,
                          isCompact: true,
                        ),
                      ...
                      Expanded(
                        child: _buildStatCard(
                          ...
                          value: _calculateAveragePerEmployee(works, formatter),
                          color: Colors.purple,
                          isCompact: true,
                        ),
                      ),
                  ...
                  const SizedBox(height: 12),
                  _buildSystemsStats(context, works, formatter),
                  ...
                  const SizedBox(height: 12),
                  _buildObjectsStats(context, works, formatter),
  ...
  String _calculateAveragePerEmployee(List works, NumberFormat formatter) {
    ...
    return '${formatter.format(totalAmount / totalEmployees)} ₽';
  }
  ...
  Widget _buildSystemsStats(
      BuildContext context, List works, NumberFormat formatter) {
    if (works.isEmpty) {
