...
class WorkMaterialFormModal extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WorkMaterialFormModal> createState() => _WorkMaterialFormModalState();
}
...
class _WorkMaterialFormModalState extends ConsumerState<WorkMaterialFormModal> {
  ...
  void _save() async {
    ...
    if (widget.initial == null) {
      await ref.read(workMaterialsProvider(widget.workId).notifier).add(material);
    } else {
      await ref.read(workMaterialsProvider(widget.workId).notifier).update(material);
    }
              ...
              Padding(
                ...
                child: Row(
                  children: [
                    Expanded(
                      child: Text(
                        widget.initial == null ? 'Добавить материал' : 'Редактировать материал',
                      ...
                      children: [
                        ...
                        TextFormField(
                          ...
                          validator: (v) {
                            ...
                            if (num.tryParse(v) == null) return 'Введите корректное число';
                            return null;
                          },
                        ),
                        const SizedBox(height: 16),
                        ...
                        TextFormField(
                          ...
                          decoration: const InputDecoration(
                            ...
                            helperText: 'Добавьте дополнительную информацию при необходимости',
                          ),
                          maxLines: 3,
                        ),
                      ],
