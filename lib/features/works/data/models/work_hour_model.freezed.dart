...
mixin _$WorkHourModel {
  ...
  $WorkHourModelCopyWith<WorkHourModel> get copyWith =>
      _$WorkHourModelCopyWithImpl<WorkHourModel>(
          this as WorkHourModel, _$identity);
  ...
  @override
  String toString() {
    return 'WorkHourModel(id: $id, workId: $workId, employeeId: $employeeId, hours: $hours, comment: $comment, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}

/// @nodoc
abstract mixin class $WorkHourModelCopyWith<$Res> {
  factory $WorkHourModelCopyWith(
          WorkHourModel value, $Res Function(WorkHourModel) _then) =
      _$WorkHourModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String workId,
...
class _WorkHourModel implements WorkHourModel {
  const _WorkHourModel(
      ...
      this.createdAt,
      this.updatedAt});
  factory _WorkHourModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WorkHourModelCopyWith<_WorkHourModel> get copyWith =>
      __$WorkHourModelCopyWithImpl<_WorkHourModel>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$WorkHourModelToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$WorkHourModelCopyWith<$Res>
    implements $WorkHourModelCopyWith<$Res> {
  factory _$WorkHourModelCopyWith(
          _WorkHourModel value, $Res Function(_WorkHourModel) _then) =
      __$WorkHourModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
