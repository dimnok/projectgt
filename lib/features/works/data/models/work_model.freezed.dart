...
@JsonKey(name: 'company_id') String get companyId;/// Дата смены.
@JsonKey(name: 'date') DateTime get date;/// Идентификатор объекта.
@JsonKey(name: 'object_id') String get objectId;/// Идентификатор пользователя, открывшего смену.
@JsonKey(name: 'opened_by') String get openedBy;/// Статус смены.
@JsonKey(name: 'status') String get status;/// Ссылка на фото смены.
@JsonKey(name: 'photo_url') String? get photoUrl;/// Ссылка на вечернее фото смены.
@JsonKey(name: 'evening_photo_url') String? get eveningPhotoUrl;/// Дата создания записи.
...
///
/// Вычисляется автоматически через триггеры БД.
@JsonKey(name: 'employees_count') int? get employeesCount;/// ID сообщения Telegram с утренним отчетом.
@JsonKey(name: 'telegram_message_id') int? get telegramMessageId;
...
@override@JsonKey(name: 'evening_photo_url') final  String? eveningPhotoUrl;
...
@override@JsonKey(name: 'telegram_message_id') final  int? telegramMessageId;
