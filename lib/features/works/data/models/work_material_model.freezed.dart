...
@JsonKey(name: 'company_id') String get companyId;/// Идентификатор смены.
@JsonKey(name: 'work_id') String get workId;/// Наименование материала.
...
$WorkMaterialModelCopyWith<WorkMaterialModel> get copyWith => _$WorkMaterialModelCopyWithImpl<WorkMaterialModel>(this as WorkMaterialModel, _$identity);
...
@override
String toString() {
  return 'WorkMaterialModel(id: $id, companyId: $companyId, workId: $workId, name: $name, unit: $unit, quantity: $quantity, comment: $comment, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
abstract mixin class $WorkMaterialModelCopyWith<$Res>  {
  factory $WorkMaterialModelCopyWith(WorkMaterialModel value, $Res Function(WorkMaterialModel) _then) = _$WorkMaterialModelCopyWithImpl;
@useResult
$Res call({
 String id,@JsonKey(name: 'company_id') String companyId,@JsonKey(name: 'work_id') String workId, String name, String unit, num quantity, String? comment,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
class _WorkMaterialModel implements WorkMaterialModel {
  const _WorkMaterialModel({required this.id, @JsonKey(name: 'company_id') required this.companyId, @JsonKey(name: 'work_id') required this.workId, required this.name, required this.unit, required this.quantity, this.comment, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt});
  factory _WorkMaterialModel.fromJson(Map<String, dynamic> json) => _$WorkMaterialModelFromJson(json);
...
/// Идентификатор смены.
@override@JsonKey(name: 'work_id') final  String workId;
...
@pragma('vm:prefer-inline')
_$WorkMaterialModelCopyWith<_WorkMaterialModel> get copyWith => __$WorkMaterialModelCopyWithImpl<_WorkMaterialModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WorkMaterialModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkMaterialModel&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.workId, workId) || other.workId == workId)&&(identical(other.name, name) || other.name == name)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.comment, comment) || other.comment == comment)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
/// @nodoc
abstract mixin class _$WorkMaterialModelCopyWith<$Res> implements $WorkMaterialModelCopyWith<$Res> {
  factory _$WorkMaterialModelCopyWith(_WorkMaterialModel value, $Res Function(_WorkMaterialModel) _then) = __$WorkMaterialModelCopyWithImpl;
@override @useResult
$Res call({
 String id,@JsonKey(name: 'company_id') String companyId,@JsonKey(name: 'work_id') String workId, String name, String unit, num quantity, String? comment,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
