...
/// Идентификатор работы.
 ...
 String get workId;/// Секция.
 String get section;/// Этаж.
 String get floor;/// Идентификатор сметы.
 String get estimateId;/// Наименование работы.
 String get name;/// Система.
 String get system;/// Подсистема.
 String get subsystem;/// Единица измерения.
 String get unit;/// Объём/количество.
 num get quantity;/// Цена за единицу.
 double? get price;/// Итоговая сумма.
 double? get total;/// Дата создания записи.
 DateTime? get createdAt;/// Дата последнего обновления.
 DateTime? get updatedAt;/// Идентификатор акта КС-2 (если работа закрыта актом).
 String? get ks2Id;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is WorkItem&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.workId, workId) || other.workId == workId)&&(identical(other.section, section) || other.section == section)&&(identical(other.floor, floor) || other.floor == floor)&&(identical(other.estimateId, estimateId) || other.estimateId == estimateId)&&(identical(other.name, name) || other.name == name)&&(identical(other.system, system) || other.system == system)&&(identical(other.subsystem, subsystem) || other.subsystem == subsystem)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.quantity, quantity) || other.quantity == quantity)&&(identical(other.price, price) || other.price == price)&&(identical(other.total, total) || other.total == total)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.ks2Id, ks2Id) || other.ks2Id == ks2Id));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,companyId,workId,section,floor,estimateId,name,system,subsystem,unit,quantity,price,total,createdAt,updatedAt,ks2Id);

@override
String toString() {
  return 'WorkItem(id: $id, companyId: $companyId, workId: $workId, section: $section, floor: $floor, estimateId: $estimateId, name: $name, system: $system, subsystem: $subsystem, unit: $unit, quantity: $quantity, price: $price, total: $total, createdAt: $createdAt, updatedAt: $updatedAt, ks2Id: $ks2Id)';
}
...
@useResult
$Res call({
 String id, String companyId, String workId, String section, String floor, String estimateId, String name, String system, String subsystem, String unit, num quantity, double? price, double? total, DateTime? createdAt, DateTime? updatedAt, String? ks2Id
});
...
/// Create a copy of WorkItem
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? companyId = null,Object? workId = null,Object? section = null,Object? floor = null,Object? estimateId = null,Object? name = null,Object? system = null,Object? subsystem = null,Object? unit = null,Object? quantity = null,Object? price = freezed,Object? total = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? ks2Id = freezed,}) {
...
class _WorkItem implements WorkItem {
  const _WorkItem({required this.id, required this.companyId, required this.workId, required this.section, required this.floor, required this.estimateId, required this.name, required this.system, required this.subsystem, required this.unit, required this.quantity, this.price, this.total, this.createdAt, this.updatedAt, this.ks2Id});
...
/// Create a copy of WorkItem
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? companyId = null,Object? workId = null,Object? section = null,Object? floor = null,Object? estimateId = null,Object? name = null,Object? system = null,Object? subsystem = null,Object? unit = null,Object? quantity = null,Object? price = freezed,Object? total = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? ks2Id = freezed,}) {
