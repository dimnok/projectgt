...
/// с компактной панелью выбора фильтров (объекты, договоры, системы, подсистемы).
class ExportFiltersAction extends ConsumerWidget {
  /// Создаёт кнопку фильтров для раскрытия всплывающей панели с фильтрами выгрузки.
  const ExportFiltersAction({super.key});

  @override

  /// Строит кнопку с иконкой фильтров и обрабатывает открытие
  /// всплывающего меню с панелью выбора фильтров выгрузки.
