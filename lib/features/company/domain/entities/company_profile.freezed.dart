...
mixin _$CompanyProfile {
  ...
  @JsonKey(name: 'director_basis')
  String? get directorBasis;
  @JsonKey(name: 'director_phone')
  String? get directorPhone;
  @JsonKey(name: 'chief_accountant_name')
  String? get chiefAccountantName;
  @JsonKey(name: 'chief_accountant_phone')
  String? get chiefAccountantPhone;
  @JsonKey(name: 'contact_person')
  String? get contactPerson;
  @JsonKey(name: 'taxation_system')
  String? get taxationSystem;
  @JsonKey(name: 'is_vat_payer')
  bool get isVatPayer;
  ...
  $CompanyProfileCopyWith<CompanyProfile> get copyWith =>
      _$CompanyProfileCopyWithImpl<CompanyProfile>(
          this as CompanyProfile, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.directorName, directorName) ||
                other.directorName == directorName) &&
            (identical(other.directorPosition, directorPosition) ||
                other.directorPosition == directorPosition) &&
            (identical(other.directorBasis, directorBasis) ||
                other.directorBasis == directorBasis) &&
            (identical(other.directorPhone, directorPhone) ||
                other.directorPhone == directorPhone) &&
            (identical(other.chiefAccountantName, chiefAccountantName) ||
                other.chiefAccountantName == chiefAccountantName) &&
            (identical(other.chiefAccountantPhone, chiefAccountantPhone) ||
                other.chiefAccountantPhone == chiefAccountantPhone) &&
            (identical(other.contactPerson, contactPerson) ||
                other.contactPerson == contactPerson) &&
            (identical(other.taxationSystem, taxationSystem) ||
                other.taxationSystem == taxationSystem) &&
            (identical(other.isVatPayer, isVatPayer) ||
                other.isVatPayer == isVatPayer) &&
...
abstract mixin class $CompanyProfileCopyWith<$Res> {
  factory $CompanyProfileCopyWith(
          CompanyProfile value, $Res Function(CompanyProfile) _then) =
      _$CompanyProfileCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      ...
      @JsonKey(name: 'is_vat_payer') bool isVatPayer,
...
class _$CompanyProfileCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? actualAddress = freezed,
    Object? directorName = freezed,
    Object? directorPosition = freezed,
    Object? directorBasis = freezed,
    Object? directorPhone = freezed,
    Object? chiefAccountantName = freezed,
    Object? chiefAccountantPhone = freezed,
    Object? contactPerson = freezed,
    Object? taxationSystem = freezed,
    Object? isVatPayer = null,
    Object? vatRate = null,
    ...
    return _then(_self.copyWith(
      ...
      legalAddress: freezed == legalAddress
          ...
          : legalAddress // ignore: cast_nullable_to_non_nullable
              as String?,
      actualAddress: freezed == actualAddress
          ? _self.actualAddress
          : actualAddress // ignore: cast_nullable_to_non_nullable
              as String?,
      directorName: freezed == directorName
          ? _self.directorName
          : directorName // ignore: cast_nullable_to_non_nullable
              as String?,
      directorPosition: freezed == directorPosition
          ? _self.directorPosition
          : directorPosition // ignore: cast_nullable_to_non_nullable
              as String?,
      directorBasis: freezed == directorBasis
          ? _self.directorBasis
          : directorBasis // ignore: cast_nullable_to_non_nullable
              as String?,
      directorPhone: freezed == directorPhone
          ? _self.directorPhone
          : directorPhone // ignore: cast_nullable_to_non_nullable
              as String?,
      chiefAccountantName: freezed == chiefAccountantName
          ? _self.chiefAccountantName
          : chiefAccountantName // ignore: cast_nullable_to_non_nullable
              as String?,
      chiefAccountantPhone: freezed == chiefAccountantPhone
          ? _self.chiefAccountantPhone
          : chiefAccountantPhone // ignore: cast_nullable_to_non_nullable
              as String?,
      contactPerson: freezed == contactPerson
          ? _self.contactPerson
          : contactPerson // ignore: cast_nullable_to_non_nullable
              as String?,
      taxationSystem: freezed == taxationSystem
          ? _self.taxationSystem
          : taxationSystem // ignore: cast_nullable_to_non_nullable
              as String?,
      isVatPayer: null == isVatPayer
          ? _self.isVatPayer
          : isVatPayer // ignore: cast_nullable_to_non_nullable
              as bool,
...
class _CompanyProfile implements CompanyProfile {
  const _CompanyProfile(
      ...
      @JsonKey(name: 'name_short') required this.nameShort,
      ...
      @JsonKey(name: 'actual_address') this.actualAddress,
      @JsonKey(name: 'director_name') this.directorName,
      @JsonKey(name: 'director_position') this.directorPosition,
      @JsonKey(name: 'director_basis') this.directorBasis,
      @JsonKey(name: 'director_phone') this.directorPhone,
      @JsonKey(name: 'chief_accountant_name') this.chiefAccountantName,
      @JsonKey(name: 'chief_accountant_phone') this.chiefAccountantPhone,
      @JsonKey(name: 'contact_person') this.contactPerson,
      @JsonKey(name: 'taxation_system') this.taxationSystem,
      @JsonKey(name: 'is_vat_payer') this.isVatPayer = false,
      @JsonKey(name: 'vat_rate') this.vatRate = 0,
  ...
  @override
  @JsonKey(name: 'chief_accountant_phone')
  final String? chiefAccountantPhone;
  @override
  @JsonKey(name: 'contact_person')
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CompanyProfileCopyWith<_CompanyProfile> get copyWith =>
      __$CompanyProfileCopyWithImpl<_CompanyProfile>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CompanyProfileToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CompanyProfileCopyWith<$Res>
    implements $CompanyProfileCopyWith<$Res> {
  factory _$CompanyProfileCopyWith(
          _CompanyProfile value, $Res Function(_CompanyProfile) _then) =
      __$CompanyProfileCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
