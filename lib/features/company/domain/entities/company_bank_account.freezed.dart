...
mixin _$CompanyBankAccount {
  ...
  $CompanyBankAccountCopyWith<CompanyBankAccount> get copyWith =>
      _$CompanyBankAccountCopyWithImpl<CompanyBankAccount>(
          this as CompanyBankAccount, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.corrAccount, corrAccount) ||
                other.corrAccount == corrAccount) &&
            (identical(other.bik, bik) || other.bik == bik) &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, companyId, bankName,
      bankCity, accountNumber, corrAccount, bik, isPrimary, createdAt);
...
abstract mixin class $CompanyBankAccountCopyWith<$Res> {
  factory $CompanyBankAccountCopyWith(
          CompanyBankAccount value, $Res Function(CompanyBankAccount) _then) =
      _$CompanyBankAccountCopyWithImpl;
  @useResult
  $Res call(
      {String id,
    ...
    return _then(_self.copyWith(
      ...
      accountNumber: null == accountNumber
          ...
          : accountNumber // ignore: cast_nullable_to_non_nullable
              as String,
      corrAccount: freezed == corrAccount
          ? _self.corrAccount
          : corrAccount // ignore: cast_nullable_to_non_nullable
              as String?,
      bik: freezed == bik
          ? _self.bik
...
class _CompanyBankAccount implements CompanyBankAccount {
  const _CompanyBankAccount(
      {required this.id,
      @JsonKey(name: 'company_id') required this.companyId,
      @JsonKey(name: 'bank_name') required this.bankName,
      @JsonKey(name: 'bank_city') this.bankCity,
      @JsonKey(name: 'account_number') required this.accountNumber,
      @JsonKey(name: 'corr_account') this.corrAccount,
      this.bik,
      @JsonKey(name: 'is_primary') this.isPrimary = false,
      @JsonKey(name: 'created_at') this.createdAt});
  factory _CompanyBankAccount.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$CompanyBankAccountCopyWith<_CompanyBankAccount> get copyWith =>
      __$CompanyBankAccountCopyWithImpl<_CompanyBankAccount>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$CompanyBankAccountToJson(
      this,
    );
  }
...
/// @nodoc
abstract mixin class _$CompanyBankAccountCopyWith<$Res>
    implements $CompanyBankAccountCopyWith<$Res> {
  factory _$CompanyBankAccountCopyWith(
          _CompanyBankAccount value, $Res Function(_CompanyBankAccount) _then) =
      __$CompanyBankAccountCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
