...
mixin _$CompanyDocument {
 ...
 String get id;@JsonKey(name: 'company_id') String get companyId; String get type; String get title; String? get number;@JsonKey(name: 'issue_date') DateTime? get issueDate;@JsonKey(name: 'expiry_date') DateTime? get expiryDate;@JsonKey(name: 'file_url') String? get fileUrl;@JsonKey(name: 'created_at') DateTime? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,companyId,type,title,number,issueDate,expiryDate,fileUrl,createdAt);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'company_id') String companyId, String type, String title, String? number,@JsonKey(name: 'issue_date') DateTime? issueDate,@JsonKey(name: 'expiry_date') DateTime? expiryDate,@JsonKey(name: 'file_url') String? fileUrl,@JsonKey(name: 'created_at') DateTime? createdAt
});
...
/// Create a copy of CompanyDocument
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? companyId = null,Object? type = null,Object? title = null,Object? number = freezed,Object? issueDate = freezed,Object? expiryDate = freezed,Object? fileUrl = freezed,Object? createdAt = freezed,}) {
...
class _CompanyDocument implements CompanyDocument {
  const _CompanyDocument({required this.id, @JsonKey(name: 'company_id') required this.companyId, required this.type, required this.title, this.number, @JsonKey(name: 'issue_date') this.issueDate, @JsonKey(name: 'expiry_date') this.expiryDate, @JsonKey(name: 'file_url') this.fileUrl, @JsonKey(name: 'created_at') this.createdAt});
  factory _CompanyDocument.fromJson(Map<String, dynamic> json) => _$CompanyDocumentFromJson(json);
...
@override
Map<String, dynamic> toJson() {
  return _$CompanyDocumentToJson(this, );
}
...
/// Create a copy of CompanyDocument
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? companyId = null,Object? type = null,Object? title = null,Object? number = freezed,Object? issueDate = freezed,Object? expiryDate = freezed,Object? fileUrl = freezed,Object? createdAt = freezed,}) {
