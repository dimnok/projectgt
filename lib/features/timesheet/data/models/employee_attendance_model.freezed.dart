...
mixin _$EmployeeAttendanceModel {
  ...
  $EmployeeAttendanceModelCopyWith<EmployeeAttendanceModel> get copyWith =>
      _$EmployeeAttendanceModelCopyWithImpl<EmployeeAttendanceModel>(
          this as EmployeeAttendanceModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EmployeeAttendanceModel &&
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, id, employeeId, objectId, date,
      hours, attendanceType, comment, createdBy, createdAt, updatedAt);

  @override
  String toString() {
    return 'EmployeeAttendanceModel(id: $id, employeeId: $employeeId, objectId: $objectId, date: $date, hours: $hours, attendanceType: $attendanceType, comment: $comment, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt)';
  }
}

/// @nodoc
abstract mixin class $EmployeeAttendanceModelCopyWith<$Res> {
  factory $EmployeeAttendanceModelCopyWith(EmployeeAttendanceModel value,
          $Res Function(EmployeeAttendanceModel) _then) =
      _$EmployeeAttendanceModelCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      ...
      String date,
      num hours,
      @JsonKey(name: 'attendance_type') AttendanceType attendanceType,
      String? comment,
...
class _EmployeeAttendanceModel implements EmployeeAttendanceModel {
  const _EmployeeAttendanceModel(
      {required this.id,
  ...
  factory _EmployeeAttendanceModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EmployeeAttendanceModelCopyWith<_EmployeeAttendanceModel> get copyWith =>
      __$EmployeeAttendanceModelCopyWithImpl<_EmployeeAttendanceModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EmployeeAttendanceModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EmployeeAttendanceModel &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.employeeId, employeeId) ||
                other.employeeId == employeeId) &&
            (identical(other.objectId, objectId) ||
...
/// @nodoc
abstract mixin class _$EmployeeAttendanceModelCopyWith<$Res>
    implements $EmployeeAttendanceModelCopyWith<$Res> {
  factory _$EmployeeAttendanceModelCopyWith(_EmployeeAttendanceModel value,
          $Res Function(_EmployeeAttendanceModel) _then) =
      __$EmployeeAttendanceModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
