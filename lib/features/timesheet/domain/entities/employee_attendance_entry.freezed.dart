...
mixin _$EmployeeAttendanceEntry {
  ...
  $EmployeeAttendanceEntryCopyWith<EmployeeAttendanceEntry> get copyWith =>
      _$EmployeeAttendanceEntryCopyWithImpl<EmployeeAttendanceEntry>(
          this as EmployeeAttendanceEntry, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EmployeeAttendanceEntry &&
  ...
  @override
  String toString() {
    return 'EmployeeAttendanceEntry(id: $id, employeeId: $employeeId, objectId: $objectId, date: $date, hours: $hours, attendanceType: $attendanceType, comment: $comment, createdBy: $createdBy, createdAt: $createdAt, updatedAt: $updatedAt, employeeName: $employeeName, employeePosition: $employeePosition, objectName: $objectName)';
  }
}

/// @nodoc
abstract mixin class $EmployeeAttendanceEntryCopyWith<$Res> {
  factory $EmployeeAttendanceEntryCopyWith(EmployeeAttendanceEntry value,
          $Res Function(EmployeeAttendanceEntry) _then) =
      _$EmployeeAttendanceEntryCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String employeeId,
...
class _EmployeeAttendanceEntry implements EmployeeAttendanceEntry {
  const _EmployeeAttendanceEntry(
      ...
      this.objectName});
  factory _EmployeeAttendanceEntry.fromJson(Map<String, dynamic> json) =>
...
// Обогащённые данные (не из БД)
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EmployeeAttendanceEntryCopyWith<_EmployeeAttendanceEntry> get copyWith =>
      __$EmployeeAttendanceEntryCopyWithImpl<_EmployeeAttendanceEntry>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EmployeeAttendanceEntryToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EmployeeAttendanceEntry &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.employeeId, employeeId) ||
                other.employeeId == employeeId) &&
            (identical(other.objectId, objectId) ||
...
/// @nodoc
abstract mixin class _$EmployeeAttendanceEntryCopyWith<$Res>
    implements $EmployeeAttendanceEntryCopyWith<$Res> {
  factory _$EmployeeAttendanceEntryCopyWith(_EmployeeAttendanceEntry value,
          $Res Function(_EmployeeAttendanceEntry) _then) =
      __$EmployeeAttendanceEntryCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
