...
mixin _$InventoryItem {
  ...
  InventoryItemCondition get condition;

  /// Тип местоположения.
  InventoryLocationType get locationType;
...
class _InventoryItem implements InventoryItem {
  const _InventoryItem(
      ...
      this.condition = InventoryItemCondition.new_,
      this.locationType = InventoryLocationType.warehouse,
      this.locationId,
      this.locationName,
      this.responsibleId,
