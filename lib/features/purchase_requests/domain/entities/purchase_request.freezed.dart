...
mixin _$PurchaseRequest {
 ...
 String get id; String get companyId; String get number; String get objectId; String? get objectName; String get createdBy; String? get createdByName; PurchaseRequestStatus get status; String? get comment; double get totalAmount; DateTime? get createdAt; DateTime? get updatedAt; DateTime? get submittedAt; DateTime? get completedAt;
...
@override
int get hashCode => Object.hash(runtimeType,id,companyId,number,objectId,objectName,createdBy,createdByName,status,comment,totalAmount,createdAt,updatedAt,submittedAt,completedAt);

@override
String toString() {
  return 'PurchaseRequest(id: $id, companyId: $companyId, number: $number, objectId: $objectId, objectName: $objectName, createdBy: $createdBy, createdByName: $createdByName, status: $status, comment: $comment, totalAmount: $totalAmount, createdAt: $createdAt, updatedAt: $updatedAt, submittedAt: $submittedAt, completedAt: $completedAt)';
}
...
@useResult
$Res call({
 String id, String companyId, String number, String objectId, String? objectName, String createdBy, String? createdByName, PurchaseRequestStatus status, String? comment, double totalAmount, DateTime? createdAt, DateTime? updatedAt, DateTime? submittedAt, DateTime? completedAt
});
...
/// Create a copy of PurchaseRequest
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? companyId = null,Object? number = null,Object? objectId = null,Object? objectName = freezed,Object? createdBy = null,Object? createdByName = freezed,Object? status = null,Object? comment = freezed,Object? totalAmount = null,Object? createdAt = freezed,Object? updatedAt = freezed,Object? submittedAt = freezed,Object? completedAt = freezed,}) {
...
class _PurchaseRequest extends PurchaseRequest {
  const _PurchaseRequest({required this.id, required this.companyId, required this.number, required this.objectId, this.objectName, required this.createdBy, this.createdByName, required this.status, this.comment, this.totalAmount = 0, this.createdAt, this.updatedAt, this.submittedAt, this.completedAt}): super._();
