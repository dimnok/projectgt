...
mixin _$SettlementOperationModel {
 ...
 String get id; String get companyId; SettlementOperationType get operationType; String get objectId; String get contractorId; String get contractId;@JsonKey(toJson: _dateOnlyToJson) DateTime? get periodFrom;@JsonKey(toJson: _dateOnlyToJson) DateTime? get periodTo; String? get actNumber;@JsonKey(toJson: _dateOnlyToJson) DateTime? get actDate; String get invoiceNumber;@JsonKey(toJson: _dateOnlyToJson) DateTime get invoiceDate; double get amount; double get vatAmount; double get advanceRetention; double get warrantyRetention; double get totalToPay; double get paidAmount; SettlementPaymentStatus get paymentStatus; String? get purpose; String? get note; DateTime? get createdAt; String? get createdBy;@JsonKey(includeToJson: false) String? get objectName;@JsonKey(includeToJson: false) String? get contractorName;@JsonKey(includeToJson: false) String? get contractNumber;
...
@useResult
$Res call({
 String id, String companyId, SettlementOperationType operationType, String objectId, String contractorId, String contractId,@JsonKey(toJson: _dateOnlyToJson) DateTime? periodFrom,@JsonKey(toJson: _dateOnlyToJson) DateTime? periodTo, String? actNumber,@JsonKey(toJson: _dateOnlyToJson) DateTime? actDate, String invoiceNumber,@JsonKey(toJson: _dateOnlyToJson) DateTime invoiceDate, double amount, double vatAmount, double advanceRetention, double warrantyRetention, double totalToPay, double paidAmount, SettlementPaymentStatus paymentStatus, String? purpose, String? note, DateTime? createdAt, String? createdBy,@JsonKey(includeToJson: false) String? objectName,@JsonKey(includeToJson: false) String? contractorName,@JsonKey(includeToJson: false) String? contractNumber
});
