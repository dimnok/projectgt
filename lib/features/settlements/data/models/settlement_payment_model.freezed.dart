...
mixin _$SettlementPaymentModel {
 ...
 String get id; String get companyId; String get settlementOperationId;@JsonKey(toJson: _dateOnlyToJson) DateTime get paymentDate; double get amount; String? get note; DateTime? get createdAt; String? get createdBy;
...
@override
String toString() {
  return 'SettlementPaymentModel(id: $id, companyId: $companyId, settlementOperationId: $settlementOperationId, paymentDate: $paymentDate, amount: $amount, note: $note, createdAt: $createdAt, createdBy: $createdBy)';
}
...
@useResult
$Res call({
 String id, String companyId, String settlementOperationId,@JsonKey(toJson: _dateOnlyToJson) DateTime paymentDate, double amount, String? note, DateTime? createdAt, String? createdBy
});
...
class _SettlementPaymentModel extends SettlementPaymentModel {
  const _SettlementPaymentModel({required this.id, required this.companyId, required this.settlementOperationId, @JsonKey(toJson: _dateOnlyToJson) required this.paymentDate, required this.amount, this.note, this.createdAt, this.createdBy}): super._();
