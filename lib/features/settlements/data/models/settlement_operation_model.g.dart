...
Map<String, dynamic> _$SettlementOperationModelToJson(
  ...
  'period_from': dateOnlyToJson(instance.periodFrom),
  'period_to': dateOnlyToJson(instance.periodTo),
  'act_number': instance.actNumber,
  'act_date': dateOnlyToJson(instance.actDate),
  'invoice_number': instance.invoiceNumber,
  'invoice_date': dateOnlyToJson(instance.invoiceDate),
