...
/// Форма заявления об отпуске
///
/// Отображает форму для заполнения данных об отпуске с предпросмотром
/// и функцией отправки на согласование руководителю.
class VacationFormBottomSheet extends StatefulWidget {
  ...
  /// Создаёт форму заявления об отпуске.
  const VacationFormBottomSheet({
    super.key,
  ...
  @override
  State<VacationFormBottomSheet> createState() =>
      _VacationFormBottomSheetState();
}
...
class _VacationFormBottomSheetState extends State<VacationFormBottomSheet> {
          ...
          build: (pw.Context context) {
            return pw.Column(
              ...
              children: [
                ...
                pw.Text(
                    'Прошу предоставить мне ежегодный оплачиваемый отпуск с ${formatRuDate(_startDate)} на $_daysCount календарных дней.',
                    style: pw.TextStyle(
  ...
  Future<void> _downloadPDF() async {
    ...
    try {
      ...
      final String fileName = '${fullName}_Отпуск_$dateStr.pdf';
