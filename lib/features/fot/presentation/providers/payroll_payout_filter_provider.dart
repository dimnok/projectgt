...
class PayrollPayoutFilterNotifier extends StateNotifier<PayrollPayoutFilterState> {
  final Ref _ref;
  ...
  void setPayoutMethodFilter(List<String> methods) => state = state.copyWith(payoutMethods: methods);
...
final payrollPayoutFilterProvider = StateNotifierProvider<PayrollPayoutFilterNotifier, PayrollPayoutFilterState>((ref) {
