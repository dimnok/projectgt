...
enum PayrollTransactionType {
  ...
  /// Лейбл для суммы
  String get amountLabel => this == PayrollTransactionType.bonus ? 'Сумма' : 'Сумма штрафа';
  
  /// Сообщение об успешном добавлении
  String get addedMessage => '$singular добавлен${this == PayrollTransactionType.bonus ? 'а' : ''}';
  
  /// Сообщение об успешном обновлении
  String get updatedMessage => '$singular обновлен${this == PayrollTransactionType.bonus ? 'а' : ''}';
} 