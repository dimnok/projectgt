...
/// Текущий статус состояния.
 ...
 String get searchQuery;/// Поисковый запрос по записям банковской выписки (ИНН или сумма).
 String get bankStatementSearchQuery;/// Выбранный год для фильтрации.
...
as String,bankStatementSearchQuery: null == bankStatementSearchQuery ? _self.bankStatementSearchQuery : bankStatementSearchQuery // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  String bankStatementSearchQuery;
