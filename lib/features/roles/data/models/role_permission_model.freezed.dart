...
mixin _$RolePermissionModel {
 ...
 String get id; String get roleId; String? get companyId; String get moduleCode; String get permissionCode; bool get isEnabled;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,roleId,companyId,moduleCode,permissionCode,isEnabled);

@override
String toString() {
  return 'RolePermissionModel(id: $id, roleId: $roleId, companyId: $companyId, moduleCode: $moduleCode, permissionCode: $permissionCode, isEnabled: $isEnabled)';
}
...
@useResult
$Res call({
 String id, String roleId, String? companyId, String moduleCode, String permissionCode, bool isEnabled
});
...
/// Create a copy of RolePermissionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? roleId = null,Object? companyId = freezed,Object? moduleCode = null,Object? permissionCode = null,Object? isEnabled = null,}) {
...
as String?,moduleCode: null == moduleCode ? _self.moduleCode : moduleCode // ignore: cast_nullable_to_non_nullable
...
class _RolePermissionModel implements RolePermissionModel {
  const _RolePermissionModel({required this.id, required this.roleId, this.companyId, required this.moduleCode, required this.permissionCode, this.isEnabled = true});
...
/// Create a copy of RolePermissionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? roleId = null,Object? companyId = freezed,Object? moduleCode = null,Object? permissionCode = null,Object? isEnabled = null,}) {
