...
///
/// Основной путь доставки при открытии/закрытии смены — очередь БД (`telegram_outbox`) и
/// Edge Function `process_telegram_outbox`. Эти методы остаются для отладки или редких
/// прямых вызовов.
///
