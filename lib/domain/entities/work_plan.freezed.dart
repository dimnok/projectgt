...
mixin _$WorkPlan {
  ...
  $WorkPlanCopyWith<WorkPlan> get copyWith =>
      _$WorkPlanCopyWithImpl<WorkPlan>(this as WorkPlan, _$identity);
  ...
  @override
  String toString() {
    return 'WorkPlan(id: $id, createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, date: $date, objectId: $objectId, objectName: $objectName, objectAddress: $objectAddress, workBlocks: $workBlocks)';
  }
}

/// @nodoc
abstract mixin class $WorkPlanCopyWith<$Res> {
  factory $WorkPlanCopyWith(WorkPlan value, $Res Function(WorkPlan) _then) =
      _$WorkPlanCopyWithImpl;
  @useResult
  $Res call(
      {String? id,
      DateTime createdAt,
...
/// @nodoc
class _$WorkPlanCopyWithImpl<$Res> implements $WorkPlanCopyWith<$Res> {
...
class _WorkPlan extends WorkPlan {
  const _WorkPlan(
      ...
      this.objectName,
      this.objectAddress,
      final List<WorkBlock> workBlocks = const []})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WorkPlanCopyWith<_WorkPlan> get copyWith =>
      __$WorkPlanCopyWithImpl<_WorkPlan>(this, _$identity);
...
/// @nodoc
abstract mixin class _$WorkPlanCopyWith<$Res>
    implements $WorkPlanCopyWith<$Res> {
  factory _$WorkPlanCopyWith(_WorkPlan value, $Res Function(_WorkPlan) _then) =
      __$WorkPlanCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
...
/// @nodoc
class __$WorkPlanCopyWithImpl<$Res> implements _$WorkPlanCopyWith<$Res> {
...
mixin _$WorkBlock {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WorkBlockCopyWith<WorkBlock> get copyWith =>
      _$WorkBlockCopyWithImpl<WorkBlock>(this as WorkBlock, _$identity);
  ...
  @override
  String toString() {
    return 'WorkBlock(id: $id, responsibleId: $responsibleId, workerIds: $workerIds, section: $section, floor: $floor, system: $system, selectedWorks: $selectedWorks)';
  }
}

/// @nodoc
abstract mixin class $WorkBlockCopyWith<$Res> {
  factory $WorkBlockCopyWith(WorkBlock value, $Res Function(WorkBlock) _then) =
      _$WorkBlockCopyWithImpl;
  @useResult
  $Res call(
      {String? id,
      ...
      String? floor,
      String system,
      List<WorkPlanItem> selectedWorks});
}

/// @nodoc
class _$WorkBlockCopyWithImpl<$Res> implements $WorkBlockCopyWith<$Res> {
...
class _WorkBlock extends WorkBlock {
  const _WorkBlock(
      ...
      final List<WorkPlanItem> selectedWorks = const []})
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WorkBlockCopyWith<_WorkBlock> get copyWith =>
      __$WorkBlockCopyWithImpl<_WorkBlock>(this, _$identity);
...
/// @nodoc
abstract mixin class _$WorkBlockCopyWith<$Res>
    implements $WorkBlockCopyWith<$Res> {
  factory _$WorkBlockCopyWith(
          _WorkBlock value, $Res Function(_WorkBlock) _then) =
      __$WorkBlockCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String? id,
...
/// @nodoc
class __$WorkBlockCopyWithImpl<$Res> implements _$WorkBlockCopyWith<$Res> {
...
mixin _$WorkPlanItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  $WorkPlanItemCopyWith<WorkPlanItem> get copyWith =>
      _$WorkPlanItemCopyWithImpl<WorkPlanItem>(
          this as WorkPlanItem, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is WorkPlanItem &&
  ...
  @override
  String toString() {
    return 'WorkPlanItem(estimateId: $estimateId, name: $name, unit: $unit, price: $price, plannedQuantity: $plannedQuantity, actualQuantity: $actualQuantity)';
  }
}

/// @nodoc
abstract mixin class $WorkPlanItemCopyWith<$Res> {
  factory $WorkPlanItemCopyWith(
          WorkPlanItem value, $Res Function(WorkPlanItem) _then) =
      _$WorkPlanItemCopyWithImpl;
  @useResult
  $Res call(
      {String estimateId,
      String name,
...
/// @nodoc
class _$WorkPlanItemCopyWithImpl<$Res> implements $WorkPlanItemCopyWith<$Res> {
...
class _WorkPlanItem extends WorkPlanItem {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$WorkPlanItemCopyWith<_WorkPlanItem> get copyWith =>
      __$WorkPlanItemCopyWithImpl<_WorkPlanItem>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _WorkPlanItem &&
            (identical(other.estimateId, estimateId) ||
                other.estimateId == estimateId) &&
            (identical(other.name, name) || other.name == name) &&
            (identical(other.unit, unit) || other.unit == unit) &&
...
/// @nodoc
abstract mixin class _$WorkPlanItemCopyWith<$Res>
    implements $WorkPlanItemCopyWith<$Res> {
  factory _$WorkPlanItemCopyWith(
          _WorkPlanItem value, $Res Function(_WorkPlanItem) _then) =
      __$WorkPlanItemCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String estimateId,
