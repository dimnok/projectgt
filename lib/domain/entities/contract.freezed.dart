...
/// Уникальный идентификатор контракта.
 ...
 ContractStatus get status;/// Тип договора по участию контрагента ([ContractKind]): заказчик, подряд, поставка.
 ContractKind get kind;/// Название организации подрядчика (для документов).
...
as ContractKind,contractorOrgName: freezed == contractorOrgName ? _self.contractorOrgName : contractorOrgName // ignore: cast_nullable_to_non_nullable
...
@override@JsonKey() final  ContractKind kind;
