...
/// Уникальный идентификатор сотрудника.
 ...
 EmployeeStatus get status;/// Учитывать в табеле. При `false` — мягкое исключение: не показывать без часов за период.
 bool get includeInTimesheet;/// Список идентификаторов объектов, к которым привязан сотрудник.
 ...
 String? get snils;/// КИГ иностранного гражданина.
 String? get kig;/// Номер патента на работу.
 String? get patentNumber;/// Дата создания записи.
...
@useResult
$Res call({
 String id, String companyId, String? photoUrl, String lastName, String firstName, String? middleName, DateTime? birthDate, String? birthPlace, String? citizenship, String? phone, String? clothingSize, String? shoeSize, String? height, DateTime? employmentDate, EmploymentType employmentType, String? position, EmployeeStatus status, bool includeInTimesheet, List<String> objectIds, String? passportSeries, String? passportNumber, String? passportIssuedBy, DateTime? passportIssueDate, String? passportDepartmentCode, String? registrationAddress, String? inn, String? snils, String? kig, String? patentNumber, DateTime? createdAt, DateTime? updatedAt, double? currentHourlyRate
});
...
class _Employee extends Employee {
  const _Employee({required this.id, required this.companyId, this.photoUrl, required this.lastName, required this.firstName, this.middleName, this.birthDate, this.birthPlace, this.citizenship, this.phone, this.clothingSize, this.shoeSize, this.height, this.employmentDate, this.employmentType = EmploymentType.official, this.position, this.status = EmployeeStatus.working, this.includeInTimesheet = true, final  List<String> objectIds = const <String>[], this.passportSeries, this.passportNumber, this.passportIssuedBy, this.passportIssueDate, this.passportDepartmentCode, this.registrationAddress, this.inn, this.snils, this.kig, this.patentNumber, this.createdAt, this.updatedAt, this.currentHourlyRate}): _objectIds = objectIds,super._();
...
@override@JsonKey() final  bool includeInTimesheet;
...
@override final  String? patentNumber;
