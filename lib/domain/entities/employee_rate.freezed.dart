...
mixin _$EmployeeRate {
  ...
  $EmployeeRateCopyWith<EmployeeRate> get copyWith =>
      _$EmployeeRateCopyWithImpl<EmployeeRate>(
          this as EmployeeRate, _$identity);
  ...
  @override
  String toString() {
    return 'EmployeeRate(id: $id, employeeId: $employeeId, hourlyRate: $hourlyRate, validFrom: $validFrom, validTo: $validTo, createdAt: $createdAt, createdBy: $createdBy)';
  }
}

/// @nodoc
abstract mixin class $EmployeeRateCopyWith<$Res> {
  factory $EmployeeRateCopyWith(
          EmployeeRate value, $Res Function(EmployeeRate) _then) =
      _$EmployeeRateCopyWithImpl;
  @useResult
  $Res call(
      {String id,
      String employeeId,
...
/// @nodoc
class _$EmployeeRateCopyWithImpl<$Res> implements $EmployeeRateCopyWith<$Res> {
...
class _EmployeeRate extends EmployeeRate {
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EmployeeRateCopyWith<_EmployeeRate> get copyWith =>
      __$EmployeeRateCopyWithImpl<_EmployeeRate>(this, _$identity);

  @override
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EmployeeRate &&
            (identical(other.id, id) || other.id == id) &&
            (identical(other.employeeId, employeeId) ||
                other.employeeId == employeeId) &&
            (identical(other.hourlyRate, hourlyRate) ||
...
/// @nodoc
abstract mixin class _$EmployeeRateCopyWith<$Res>
    implements $EmployeeRateCopyWith<$Res> {
  factory _$EmployeeRateCopyWith(
          _EmployeeRate value, $Res Function(_EmployeeRate) _then) =
      __$EmployeeRateCopyWithImpl;
  @override
  @useResult
  $Res call(
      {String id,
