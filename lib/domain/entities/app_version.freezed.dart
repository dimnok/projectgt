...
/// Идентификатор версии.
 String get id;/// Текущая последняя версия приложения.
 String get currentVersion;/// Минимальная поддерживаемая версия.
 String get minimumVersion;/// Флаг принудительного обновления.
 bool get forceUpdate;/// Сообщение для пользователя об обновлении.
 String? get updateMessage;/// Дата создания записи.
...
@useResult
$Res call({
 String id, String currentVersion, String minimumVersion, bool forceUpdate, String? updateMessage, DateTime? createdAt, DateTime? updatedAt
});
...
class _AppVersion implements AppVersion {
  const _AppVersion({required this.id, required this.currentVersion, required this.minimumVersion, required this.forceUpdate, this.updateMessage, this.createdAt, this.updatedAt});
