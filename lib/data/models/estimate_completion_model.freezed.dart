...
mixin _$EstimateCompletionModel {
  ...
  $EstimateCompletionModelCopyWith<EstimateCompletionModel> get copyWith =>
      _$EstimateCompletionModelCopyWithImpl<EstimateCompletionModel>(
          this as EstimateCompletionModel, _$identity);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is EstimateCompletionModel &&
            ...
            (identical(other.completedQuantity, completedQuantity) ||
                other.completedQuantity == completedQuantity) &&
            (identical(other.completedTotal, completedTotal) ||
...
abstract mixin class $EstimateCompletionModelCopyWith<$Res> {
  factory $EstimateCompletionModelCopyWith(EstimateCompletionModel value,
          $Res Function(EstimateCompletionModel) _then) =
      _$EstimateCompletionModelCopyWithImpl;
  @useResult
  $Res call(
      {@JsonKey(name: 'estimate_id', fromJson: _parseString) String estimateId,
      @JsonKey(name: 'object_id', fromJson: _parseString) String objectId,
      @JsonKey(name: 'contract_id', fromJson: _parseString) String contractId,
      String system,
      String subsystem,
      String number,
      String name,
      String unit,
      @JsonKey(fromJson: _parseDouble) double quantity,
      @JsonKey(fromJson: _parseDouble) double total,
      @JsonKey(name: 'completed_quantity', fromJson: _parseDouble)
      double completedQuantity,
      @JsonKey(name: 'completed_total', fromJson: _parseDouble)
      double completedTotal,
      @JsonKey(fromJson: _parseDouble) double percentage,
      @JsonKey(name: 'remaining_quantity', fromJson: _parseDouble)
...
class _$EstimateCompletionModelCopyWithImpl<$Res>
  ...
  $Res call({
    ...
    Object? total = null,
    Object? completedQuantity = null,
    Object? completedTotal = null,
    ...
    return _then(_self.copyWith(
      ...
      total: null == total
          ...
          : total // ignore: cast_nullable_to_non_nullable
              as double,
      completedQuantity: null == completedQuantity
          ? _self.completedQuantity
          : completedQuantity // ignore: cast_nullable_to_non_nullable
              as double,
      completedTotal: null == completedTotal
          ? _self.completedTotal
          : completedTotal // ignore: cast_nullable_to_non_nullable
              as double,
...
class _EstimateCompletionModel implements EstimateCompletionModel {
  const _EstimateCompletionModel(
      {@JsonKey(name: 'estimate_id', fromJson: _parseString)
      this.estimateId = '',
      @JsonKey(name: 'object_id', fromJson: _parseString) this.objectId = '',
      @JsonKey(name: 'contract_id', fromJson: _parseString)
      this.contractId = '',
      this.system = '',
      this.subsystem = '',
      ...
      this.name = '',
      this.unit = '',
      @JsonKey(fromJson: _parseDouble) this.quantity = 0.0,
      @JsonKey(fromJson: _parseDouble) this.total = 0.0,
      @JsonKey(name: 'completed_quantity', fromJson: _parseDouble)
      this.completedQuantity = 0.0,
      @JsonKey(name: 'completed_total', fromJson: _parseDouble)
      this.completedTotal = 0.0,
      @JsonKey(fromJson: _parseDouble) this.percentage = 0.0,
      @JsonKey(name: 'remaining_quantity', fromJson: _parseDouble)
      this.remainingQuantity = 0.0});
  factory _EstimateCompletionModel.fromJson(Map<String, dynamic> json) =>
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @pragma('vm:prefer-inline')
  _$EstimateCompletionModelCopyWith<_EstimateCompletionModel> get copyWith =>
      __$EstimateCompletionModelCopyWithImpl<_EstimateCompletionModel>(
          this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$EstimateCompletionModelToJson(
      this,
    );
  }
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _EstimateCompletionModel &&
            (identical(other.estimateId, estimateId) ||
                other.estimateId == estimateId) &&
            (identical(other.objectId, objectId) ||
                other.objectId == objectId) &&
...
/// @nodoc
abstract mixin class _$EstimateCompletionModelCopyWith<$Res>
    implements $EstimateCompletionModelCopyWith<$Res> {
  factory _$EstimateCompletionModelCopyWith(_EstimateCompletionModel value,
          $Res Function(_EstimateCompletionModel) _then) =
      __$EstimateCompletionModelCopyWithImpl;
  @override
  @useResult
  $Res call(
      {@JsonKey(name: 'estimate_id', fromJson: _parseString) String estimateId,
