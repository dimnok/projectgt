...
_EstimateCompletionModel _$EstimateCompletionModelFromJson(
    ...
    _EstimateCompletionModel(
      estimateId:
          json['estimate_id'] == null ? '' : _parseString(json['estimate_id']),
      objectId:
          json['object_id'] == null ? '' : _parseString(json['object_id']),
      contractId:
          json['contract_id'] == null ? '' : _parseString(json['contract_id']),
      ...
      percentage:
          json['percentage'] == null ? 0.0 : _parseDouble(json['percentage']),
