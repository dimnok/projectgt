...
@useResult
$Res call({
 String id, String companyId,@JsonKey(name: 'photo_url') String? photoUrl,@JsonKey(name: 'last_name') String lastName,@JsonKey(name: 'first_name') String firstName,@JsonKey(name: 'middle_name') String? middleName,@JsonKey(name: 'birth_date') DateTime? birthDate,@JsonKey(name: 'birth_place') String? birthPlace, String? citizenship, String? phone,@JsonKey(name: 'clothing_size') String? clothingSize,@JsonKey(name: 'shoe_size') String? shoeSize, String? height,@JsonKey(name: 'employment_date') DateTime? employmentDate,@JsonKey(name: 'employment_type') EmploymentType employmentType, String? position, EmployeeStatus status,@JsonKey(name: 'include_in_timesheet') bool includeInTimesheet,@JsonKey(name: 'object_ids') List<String> objectIds,@JsonKey(name: 'passport_series') String? passportSeries,@JsonKey(name: 'passport_number') String? passportNumber,@JsonKey(name: 'passport_issued_by') String? passportIssuedBy,@JsonKey(name: 'passport_issue_date') DateTime? passportIssueDate,@JsonKey(name: 'passport_department_code') String? passportDepartmentCode,@JsonKey(name: 'registration_address') String? registrationAddress, String? inn, String? snils, String? kig,@JsonKey(name: 'patent_number') String? patentNumber,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'current_hourly_rate', includeFromJson: false, includeToJson: false) double? currentHourlyRate
});
...
/// Create a copy of EmployeeModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? companyId = null,Object? photoUrl = freezed,Object? lastName = null,Object? firstName = null,Object? middleName = freezed,Object? birthDate = freezed,Object? birthPlace = freezed,Object? citizenship = freezed,Object? phone = freezed,Object? clothingSize = freezed,Object? shoeSize = freezed,Object? height = freezed,Object? employmentDate = freezed,Object? employmentType = null,Object? position = freezed,Object? status = null,Object? includeInTimesheet = null,Object? objectIds = null,Object? passportSeries = freezed,Object? passportNumber = freezed,Object? passportIssuedBy = freezed,Object? passportIssueDate = freezed,Object? passportDepartmentCode = freezed,Object? registrationAddress = freezed,Object? inn = freezed,Object? snils = freezed,Object? kig = freezed,Object? patentNumber = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,Object? currentHourlyRate = freezed,}) {
...
as EmployeeStatus,includeInTimesheet: null == includeInTimesheet ? _self.includeInTimesheet : includeInTimesheet // ignore: cast_nullable_to_non_nullable
as bool,objectIds: null == objectIds ? _self.objectIds : objectIds // ignore: cast_nullable_to_non_nullable
...
as String?,kig: freezed == kig ? _self.kig : kig // ignore: cast_nullable_to_non_nullable
as String?,patentNumber: freezed == patentNumber ? _self.patentNumber : patentNumber // ignore: cast_nullable_to_non_nullable
...
class _EmployeeModel extends EmployeeModel {
  const _EmployeeModel({required this.id, required this.companyId, @JsonKey(name: 'photo_url') this.photoUrl, @JsonKey(name: 'last_name') required this.lastName, @JsonKey(name: 'first_name') required this.firstName, @JsonKey(name: 'middle_name') this.middleName, @JsonKey(name: 'birth_date') this.birthDate, @JsonKey(name: 'birth_place') this.birthPlace, this.citizenship, this.phone, @JsonKey(name: 'clothing_size') this.clothingSize, @JsonKey(name: 'shoe_size') this.shoeSize, this.height, @JsonKey(name: 'employment_date') this.employmentDate, @JsonKey(name: 'employment_type') this.employmentType = EmploymentType.official, this.position, this.status = EmployeeStatus.working, @JsonKey(name: 'include_in_timesheet') this.includeInTimesheet = true, @JsonKey(name: 'object_ids') final  List<String> objectIds = const <String>[], @JsonKey(name: 'passport_series') this.passportSeries, @JsonKey(name: 'passport_number') this.passportNumber, @JsonKey(name: 'passport_issued_by') this.passportIssuedBy, @JsonKey(name: 'passport_issue_date') this.passportIssueDate, @JsonKey(name: 'passport_department_code') this.passportDepartmentCode, @JsonKey(name: 'registration_address') this.registrationAddress, this.inn, this.snils, this.kig, @JsonKey(name: 'patent_number') this.patentNumber, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt, @JsonKey(name: 'current_hourly_rate', includeFromJson: false, includeToJson: false) this.currentHourlyRate}): _objectIds = objectIds,super._();
...
@override@JsonKey(name: 'include_in_timesheet') final  bool includeInTimesheet;
...
@override final  String? kig;
@override@JsonKey(name: 'patent_number') final  String? patentNumber;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _EmployeeModel&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.photoUrl, photoUrl) || other.photoUrl == photoUrl)&&(identical(other.lastName, lastName) || other.lastName == lastName)&&(identical(other.firstName, firstName) || other.firstName == firstName)&&(identical(other.middleName, middleName) || other.middleName == middleName)&&(identical(other.birthDate, birthDate) || other.birthDate == birthDate)&&(identical(other.birthPlace, birthPlace) || other.birthPlace == birthPlace)&&(identical(other.citizenship, citizenship) || other.citizenship == citizenship)&&(identical(other.phone, phone) || other.phone == phone)&&(identical(other.clothingSize, clothingSize) || other.clothingSize == clothingSize)&&(identical(other.shoeSize, shoeSize) || other.shoeSize == shoeSize)&&(identical(other.height, height) || other.height == height)&&(identical(other.employmentDate, employmentDate) || other.employmentDate == employmentDate)&&(identical(other.employmentType, employmentType) || other.employmentType == employmentType)&&(identical(other.position, position) || other.position == position)&&(identical(other.status, status) || other.status == status)&&(identical(other.includeInTimesheet, includeInTimesheet) || other.includeInTimesheet == includeInTimesheet)&&const DeepCollectionEquality().equals(other._objectIds, _objectIds)&&(identical(other.passportSeries, passportSeries) || other.passportSeries == passportSeries)&&(identical(other.passportNumber, passportNumber) || other.passportNumber == passportNumber)&&(identical(other.passportIssuedBy, passportIssuedBy) || other.passportIssuedBy == passportIssuedBy)&&(identical(other.passportIssueDate, passportIssueDate) || other.passportIssueDate == passportIssueDate)&&(identical(other.passportDepartmentCode, passportDepartmentCode) || other.passportDepartmentCode == passportDepartmentCode)&&(identical(other.registrationAddress, registrationAddress) || other.registrationAddress == registrationAddress)&&(identical(other.inn, inn) || other.inn == inn)&&(identical(other.snils, snils) || other.snils == snils)&&(identical(other.kig, kig) || other.kig == kig)&&(identical(other.patentNumber, patentNumber) || other.patentNumber == patentNumber)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.currentHourlyRate, currentHourlyRate) || other.currentHourlyRate == currentHourlyRate));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,companyId,photoUrl,lastName,firstName,middleName,birthDate,birthPlace,citizenship,phone,clothingSize,shoeSize,height,employmentDate,employmentType,position,status,includeInTimesheet,const DeepCollectionEquality().hash(_objectIds),passportSeries,passportNumber,passportIssuedBy,passportIssueDate,passportDepartmentCode,registrationAddress,inn,snils,kig,patentNumber,createdAt,updatedAt,currentHourlyRate]);
...
as String?,status: null == status ? _self.status : status // ignore: cast_nullable_to_non_nullable
as EmployeeStatus,includeInTimesheet: null == includeInTimesheet ? _self.includeInTimesheet : includeInTimesheet // ignore: cast_nullable_to_non_nullable
as bool,objectIds: null == objectIds ? _self._objectIds : objectIds // ignore: cast_nullable_to_non_nullable
as List<String>,passportSeries: freezed == passportSeries ? _self.passportSeries : passportSeries // ignore: cast_nullable_to_non_nullable
as String?,passportNumber: freezed == passportNumber ? _self.passportNumber : passportNumber // ignore: cast_nullable_to_non_nullable
as String?,passportIssuedBy: freezed == passportIssuedBy ? _self.passportIssuedBy : passportIssuedBy // ignore: cast_nullable_to_non_nullable
as String?,passportIssueDate: freezed == passportIssueDate ? _self.passportIssueDate : passportIssueDate // ignore: cast_nullable_to_non_nullable
