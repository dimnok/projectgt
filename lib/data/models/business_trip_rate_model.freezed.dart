...
mixin _$BusinessTripRateModel {
 ...
 String get id; String get objectId; String? get employeeId; double get rate; double get minimumHours; DateTime get validFrom; DateTime? get validTo; DateTime? get createdAt; DateTime? get updatedAt; String? get createdBy;
/// Create a copy of BusinessTripRateModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$BusinessTripRateModelCopyWith<BusinessTripRateModel> get copyWith => _$BusinessTripRateModelCopyWithImpl<BusinessTripRateModel>(this as BusinessTripRateModel, _$identity);
...
abstract mixin class $BusinessTripRateModelCopyWith<$Res>  {
  factory $BusinessTripRateModelCopyWith(BusinessTripRateModel value, $Res Function(BusinessTripRateModel) _then) = _$BusinessTripRateModelCopyWithImpl;
@useResult
$Res call({
...
class _BusinessTripRateModel extends BusinessTripRateModel {
  const _BusinessTripRateModel({required this.id, required this.objectId, this.employeeId, required this.rate, this.minimumHours = 0.0, required this.validFrom, this.validTo, this.createdAt, this.updatedAt, this.createdBy}): super._();
  factory _BusinessTripRateModel.fromJson(Map<String, dynamic> json) => _$BusinessTripRateModelFromJson(json);
...
@pragma('vm:prefer-inline')
_$BusinessTripRateModelCopyWith<_BusinessTripRateModel> get copyWith => __$BusinessTripRateModelCopyWithImpl<_BusinessTripRateModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$BusinessTripRateModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _BusinessTripRateModel&&(identical(other.id, id) || other.id == id)&&(identical(other.objectId, objectId) || other.objectId == objectId)&&(identical(other.employeeId, employeeId) || other.employeeId == employeeId)&&(identical(other.rate, rate) || other.rate == rate)&&(identical(other.minimumHours, minimumHours) || other.minimumHours == minimumHours)&&(identical(other.validFrom, validFrom) || other.validFrom == validFrom)&&(identical(other.validTo, validTo) || other.validTo == validTo)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy));
}
...
/// @nodoc
abstract mixin class _$BusinessTripRateModelCopyWith<$Res> implements $BusinessTripRateModelCopyWith<$Res> {
  factory _$BusinessTripRateModelCopyWith(_BusinessTripRateModel value, $Res Function(_BusinessTripRateModel) _then) = __$BusinessTripRateModelCopyWithImpl;
@override @useResult
$Res call({
 String id, String objectId, String? employeeId, double rate, double minimumHours, DateTime validFrom, DateTime? validTo, DateTime? createdAt, DateTime? updatedAt, String? createdBy
});
