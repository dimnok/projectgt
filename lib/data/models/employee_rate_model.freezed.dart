...
@JsonKey(name: 'company_id') String get companyId;/// Идентификатор сотрудника
@JsonKey(name: 'employee_id') String get employeeId;/// Почасовая ставка в рублях
@JsonKey(name: 'hourly_rate') double get hourlyRate;/// Дата начала действия ставки
@JsonKey(name: 'valid_from') DateTime get validFrom;/// Дата окончания действия ставки (null означает текущую ставку)
@JsonKey(name: 'valid_to') DateTime? get validTo;/// Дата создания записи
@JsonKey(name: 'created_at') DateTime? get createdAt;/// Идентификатор пользователя, создавшего запись
...
@override
String toString() {
  return 'EmployeeRateModel(id: $id, companyId: $companyId, employeeId: $employeeId, hourlyRate: $hourlyRate, validFrom: $validFrom, validTo: $validTo, createdAt: $createdAt, createdBy: $createdBy)';
}
...
class _EmployeeRateModel extends EmployeeRateModel {
  const _EmployeeRateModel({required this.id, @JsonKey(name: 'company_id') required this.companyId, @JsonKey(name: 'employee_id') required this.employeeId, @JsonKey(name: 'hourly_rate') required this.hourlyRate, @JsonKey(name: 'valid_from') required this.validFrom, @JsonKey(name: 'valid_to') this.validTo, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'created_by') this.createdBy}): super._();
