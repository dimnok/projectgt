...
mixin _$ContractModel {
 ...
 String get id; String get companyId; String get number;@JsonKey(toJson: _dateOnlyToJson) DateTime get date;@JsonKey(toJson: _dateOnlyToJson) DateTime? get endDate; String get contractorId; String? get contractorName; double get amount; double get vatRate; bool get isVatIncluded; double get vatAmount; double get advanceAmount; double get warrantyRetentionAmount; double get warrantyRetentionRate; int get warrantyPeriodMonths; double get generalContractorFeeAmount; double get generalContractorFeeRate; String get objectId; String? get objectName; ContractStatus get status;@JsonKey(name: 'contract_kind') ContractKind get kind;// Новые поля для подписантов (маппятся на _legal_name в БД через snake_case)
 String? get contractorLegalName; String? get contractorPosition; String? get contractorSigner; String? get customerLegalName; String? get customerPosition; String? get customerSigner; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
 String id, String companyId, String number,@JsonKey(toJson: _dateOnlyToJson) DateTime date,@JsonKey(toJson: _dateOnlyToJson) DateTime? endDate, String contractorId, String? contractorName, double amount, double vatRate, bool isVatIncluded, double vatAmount, double advanceAmount, double warrantyRetentionAmount, double warrantyRetentionRate, int warrantyPeriodMonths, double generalContractorFeeAmount, double generalContractorFeeRate, String objectId, String? objectName, ContractStatus status,@JsonKey(name: 'contract_kind') ContractKind kind, String? contractorLegalName, String? contractorPosition, String? contractorSigner, String? customerLegalName, String? customerPosition, String? customerSigner, DateTime? createdAt, DateTime? updatedAt
});
...
as ContractStatus,kind: null == kind ? _self.kind : kind // ignore: cast_nullable_to_non_nullable
as ContractKind,contractorLegalName: freezed == contractorLegalName ? _self.contractorLegalName : contractorLegalName // ignore: cast_nullable_to_non_nullable
...
as String?,customerLegalName: freezed == customerLegalName ? _self.customerLegalName : customerLegalName // ignore: cast_nullable_to_non_nullable
...
class _ContractModel extends ContractModel {
  const _ContractModel({required this.id, required this.companyId, required this.number, @JsonKey(toJson: _dateOnlyToJson) required this.date, @JsonKey(toJson: _dateOnlyToJson) this.endDate, required this.contractorId, this.contractorName, required this.amount, this.vatRate = 0.0, this.isVatIncluded = true, this.vatAmount = 0.0, this.advanceAmount = 0.0, this.warrantyRetentionAmount = 0.0, this.warrantyRetentionRate = 0.0, this.warrantyPeriodMonths = 0, this.generalContractorFeeAmount = 0.0, this.generalContractorFeeRate = 0.0, required this.objectId, this.objectName, this.status = ContractStatus.active, @JsonKey(name: 'contract_kind') this.kind = ContractKind.customer, this.contractorLegalName, this.contractorPosition, this.contractorSigner, this.customerLegalName, this.customerPosition, this.customerSigner, this.createdAt, this.updatedAt}): super._();
...
@override@JsonKey(toJson: _dateOnlyToJson) final  DateTime? endDate;
