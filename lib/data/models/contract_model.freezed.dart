...
mixin _$ContractModel {
 ...
 String get id; String get companyId; String get number;@JsonKey(toJson: _dateOnlyToJson) DateTime get date;@JsonKey(toJson: _dateOnlyToJson) DateTime? get endDate; String get contractorId; String? get contractorName; double get amount; double get vatRate; bool get isVatIncluded; double get vatAmount; double get advanceAmount; double get warrantyRetentionAmount; double get warrantyRetentionRate; int get warrantyPeriodMonths; double get generalContractorFeeAmount; double get generalContractorFeeRate; String get objectId; String? get objectName; ContractStatus get status;// Новые поля для подписантов (маппятся на _legal_name в БД через snake_case)
...
as ContractStatus,contractorLegalName: freezed == contractorLegalName ? _self.contractorLegalName : contractorLegalName // ignore: cast_nullable_to_non_nullable
