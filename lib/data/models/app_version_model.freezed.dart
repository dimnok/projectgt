...
mixin _$AppVersionModel {
 ...
 String get id;@JsonKey(name: 'current_version') String get currentVersion;@JsonKey(name: 'minimum_version') String get minimumVersion;@JsonKey(name: 'force_update') bool get forceUpdate;@JsonKey(name: 'update_message') String? get updateMessage;@JsonKey(name: 'created_at') DateTime? get createdAt;@JsonKey(name: 'updated_at') DateTime? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,currentVersion,minimumVersion,forceUpdate,updateMessage,createdAt,updatedAt);
...
@useResult
$Res call({
 String id,@JsonKey(name: 'current_version') String currentVersion,@JsonKey(name: 'minimum_version') String minimumVersion,@JsonKey(name: 'force_update') bool forceUpdate,@JsonKey(name: 'update_message') String? updateMessage,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt
});
...
/// Create a copy of AppVersionModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? currentVersion = null,Object? minimumVersion = null,Object? forceUpdate = null,Object? updateMessage = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
...
as bool,updateMessage: freezed == updateMessage ? _self.updateMessage : updateMessage // ignore: cast_nullable_to_non_nullable
...
class _AppVersionModel implements AppVersionModel {
  const _AppVersionModel({required this.id, @JsonKey(name: 'current_version') required this.currentVersion, @JsonKey(name: 'minimum_version') required this.minimumVersion, @JsonKey(name: 'force_update') required this.forceUpdate, @JsonKey(name: 'update_message') this.updateMessage, @JsonKey(name: 'created_at') this.createdAt, @JsonKey(name: 'updated_at') this.updatedAt});
...
@override@JsonKey(name: 'update_message') final  String? updateMessage;
...
/// Create a copy of AppVersionModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? currentVersion = null,Object? minimumVersion = null,Object? forceUpdate = null,Object? updateMessage = freezed,Object? createdAt = freezed,Object? updatedAt = freezed,}) {
