...
@JsonKey(includeIfNull: false) String? get id; String get companyId; DateTime get createdAt; DateTime get updatedAt; String get createdBy; DateTime get date; String get objectId;@JsonKey(includeIfNull: false) String? get objectName;@JsonKey(includeIfNull: false) String? get objectAddress; List<WorkBlockModel> get workBlocks;
/// Create a copy of WorkPlanModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WorkPlanModelCopyWith<WorkPlanModel> get copyWith => _$WorkPlanModelCopyWithImpl<WorkPlanModel>(this as WorkPlanModel, _$identity);
...
@override
String toString() {
  return 'WorkPlanModel(id: $id, companyId: $companyId, createdAt: $createdAt, updatedAt: $updatedAt, createdBy: $createdBy, date: $date, objectId: $objectId, objectName: $objectName, objectAddress: $objectAddress, workBlocks: $workBlocks)';
}
...
abstract mixin class $WorkPlanModelCopyWith<$Res>  {
  factory $WorkPlanModelCopyWith(WorkPlanModel value, $Res Function(WorkPlanModel) _then) = _$WorkPlanModelCopyWithImpl;
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? id, String companyId, DateTime createdAt, DateTime updatedAt, String createdBy, DateTime date, String objectId,@JsonKey(includeIfNull: false) String? objectName,@JsonKey(includeIfNull: false) String? objectAddress, List<WorkBlockModel> workBlocks
});
...
class _WorkPlanModel extends WorkPlanModel {
  const _WorkPlanModel({@JsonKey(includeIfNull: false) this.id, required this.companyId, required this.createdAt, required this.updatedAt, required this.createdBy, required this.date, required this.objectId, @JsonKey(includeIfNull: false) this.objectName, @JsonKey(includeIfNull: false) this.objectAddress, final  List<WorkBlockModel> workBlocks = const []}): _workBlocks = workBlocks,super._();
  factory _WorkPlanModel.fromJson(Map<String, dynamic> json) => _$WorkPlanModelFromJson(json);
...
@override@JsonKey(includeIfNull: false) final  String? objectName;
@override@JsonKey(includeIfNull: false) final  String? objectAddress;
 final  List<WorkBlockModel> _workBlocks;
@override@JsonKey() List<WorkBlockModel> get workBlocks {
...
@pragma('vm:prefer-inline')
_$WorkPlanModelCopyWith<_WorkPlanModel> get copyWith => __$WorkPlanModelCopyWithImpl<_WorkPlanModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WorkPlanModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkPlanModel&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt)&&(identical(other.createdBy, createdBy) || other.createdBy == createdBy)&&(identical(other.date, date) || other.date == date)&&(identical(other.objectId, objectId) || other.objectId == objectId)&&(identical(other.objectName, objectName) || other.objectName == objectName)&&(identical(other.objectAddress, objectAddress) || other.objectAddress == objectAddress)&&const DeepCollectionEquality().equals(other._workBlocks, _workBlocks));
}
...
/// @nodoc
abstract mixin class _$WorkPlanModelCopyWith<$Res> implements $WorkPlanModelCopyWith<$Res> {
  factory _$WorkPlanModelCopyWith(_WorkPlanModel value, $Res Function(_WorkPlanModel) _then) = __$WorkPlanModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(includeIfNull: false) String? id, String companyId, DateTime createdAt, DateTime updatedAt, String createdBy, DateTime date, String objectId,@JsonKey(includeIfNull: false) String? objectName,@JsonKey(includeIfNull: false) String? objectAddress, List<WorkBlockModel> workBlocks
});
...
mixin _$WorkPlanItemModel {
 ...
 String get companyId; String get estimateId; String get name; String get unit; double get price; double get plannedQuantity; double get actualQuantity;
/// Create a copy of WorkPlanItemModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WorkPlanItemModelCopyWith<WorkPlanItemModel> get copyWith => _$WorkPlanItemModelCopyWithImpl<WorkPlanItemModel>(this as WorkPlanItemModel, _$identity);
...
@override
String toString() {
  return 'WorkPlanItemModel(companyId: $companyId, estimateId: $estimateId, name: $name, unit: $unit, price: $price, plannedQuantity: $plannedQuantity, actualQuantity: $actualQuantity)';
}
...
abstract mixin class $WorkPlanItemModelCopyWith<$Res>  {
  factory $WorkPlanItemModelCopyWith(WorkPlanItemModel value, $Res Function(WorkPlanItemModel) _then) = _$WorkPlanItemModelCopyWithImpl;
@useResult
$Res call({
...
class _WorkPlanItemModel extends WorkPlanItemModel {
  const _WorkPlanItemModel({required this.companyId, required this.estimateId, required this.name, required this.unit, required this.price, this.plannedQuantity = 0, this.actualQuantity = 0}): super._();
  factory _WorkPlanItemModel.fromJson(Map<String, dynamic> json) => _$WorkPlanItemModelFromJson(json);
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$WorkPlanItemModelCopyWith<_WorkPlanItemModel> get copyWith => __$WorkPlanItemModelCopyWithImpl<_WorkPlanItemModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WorkPlanItemModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkPlanItemModel&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.estimateId, estimateId) || other.estimateId == estimateId)&&(identical(other.name, name) || other.name == name)&&(identical(other.unit, unit) || other.unit == unit)&&(identical(other.price, price) || other.price == price)&&(identical(other.plannedQuantity, plannedQuantity) || other.plannedQuantity == plannedQuantity)&&(identical(other.actualQuantity, actualQuantity) || other.actualQuantity == actualQuantity));
}
...
/// @nodoc
abstract mixin class _$WorkPlanItemModelCopyWith<$Res> implements $WorkPlanItemModelCopyWith<$Res> {
  factory _$WorkPlanItemModelCopyWith(_WorkPlanItemModel value, $Res Function(_WorkPlanItemModel) _then) = __$WorkPlanItemModelCopyWithImpl;
@override @useResult
$Res call({
 String companyId, String estimateId, String name, String unit, double price, double plannedQuantity, double actualQuantity
});
...
@JsonKey(includeIfNull: false) String? get id;/// ID компании.
 String get companyId;/// ID ответственного сотрудника за блок.
@JsonKey(includeIfNull: false) String? get responsibleId;/// Список ID работников, назначенных на блок.
 List<String> get workerIds;/// Участок объекта для данного блока.
@JsonKey(includeIfNull: false) String? get section;/// Этаж объекта для данного блока.
@JsonKey(includeIfNull: false) String? get floor;/// Система работ (обязательное поле).
 String get system;/// Список работ в блоке с объемами.
@JsonKey(name: 'work_plan_items') List<WorkPlanItemModel> get selectedWorks;
/// Create a copy of WorkBlockModel
/// with the given fields replaced by the non-null parameter values.
@JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
$WorkBlockModelCopyWith<WorkBlockModel> get copyWith => _$WorkBlockModelCopyWithImpl<WorkBlockModel>(this as WorkBlockModel, _$identity);
...
@override
String toString() {
  return 'WorkBlockModel(id: $id, companyId: $companyId, responsibleId: $responsibleId, workerIds: $workerIds, section: $section, floor: $floor, system: $system, selectedWorks: $selectedWorks)';
}
...
abstract mixin class $WorkBlockModelCopyWith<$Res>  {
  factory $WorkBlockModelCopyWith(WorkBlockModel value, $Res Function(WorkBlockModel) _then) = _$WorkBlockModelCopyWithImpl;
@useResult
$Res call({
@JsonKey(includeIfNull: false) String? id, String companyId,@JsonKey(includeIfNull: false) String? responsibleId, List<String> workerIds,@JsonKey(includeIfNull: false) String? section,@JsonKey(includeIfNull: false) String? floor, String system,@JsonKey(name: 'work_plan_items') List<WorkPlanItemModel> selectedWorks
});
...
class _WorkBlockModel implements WorkBlockModel {
  const _WorkBlockModel({@JsonKey(includeIfNull: false) this.id, required this.companyId, @JsonKey(includeIfNull: false) this.responsibleId, final  List<String> workerIds = const [], @JsonKey(includeIfNull: false) this.section, @JsonKey(includeIfNull: false) this.floor, required this.system, @JsonKey(name: 'work_plan_items') final  List<WorkPlanItemModel> selectedWorks = const []}): _workerIds = workerIds,_selectedWorks = selectedWorks;
  factory _WorkBlockModel.fromJson(Map<String, dynamic> json) => _$WorkBlockModelFromJson(json);
...
@override@JsonKey(includeIfNull: false) final  String? responsibleId;
...
@override@JsonKey(includeIfNull: false) final  String? section;
/// Этаж объекта для данного блока.
@override@JsonKey(includeIfNull: false) final  String? floor;
...
/// Список работ в блоке с объемами.
@override@JsonKey(name: 'work_plan_items') List<WorkPlanItemModel> get selectedWorks {
...
@override @JsonKey(includeFromJson: false, includeToJson: false)
@pragma('vm:prefer-inline')
_$WorkBlockModelCopyWith<_WorkBlockModel> get copyWith => __$WorkBlockModelCopyWithImpl<_WorkBlockModel>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$WorkBlockModelToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _WorkBlockModel&&(identical(other.id, id) || other.id == id)&&(identical(other.companyId, companyId) || other.companyId == companyId)&&(identical(other.responsibleId, responsibleId) || other.responsibleId == responsibleId)&&const DeepCollectionEquality().equals(other._workerIds, _workerIds)&&(identical(other.section, section) || other.section == section)&&(identical(other.floor, floor) || other.floor == floor)&&(identical(other.system, system) || other.system == system)&&const DeepCollectionEquality().equals(other._selectedWorks, _selectedWorks));
}
...
/// @nodoc
abstract mixin class _$WorkBlockModelCopyWith<$Res> implements $WorkBlockModelCopyWith<$Res> {
  factory _$WorkBlockModelCopyWith(_WorkBlockModel value, $Res Function(_WorkBlockModel) _then) = __$WorkBlockModelCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(includeIfNull: false) String? id, String companyId,@JsonKey(includeIfNull: false) String? responsibleId, List<String> workerIds,@JsonKey(includeIfNull: false) String? section,@JsonKey(includeIfNull: false) String? floor, String system,@JsonKey(name: 'work_plan_items') List<WorkPlanItemModel> selectedWorks
});
