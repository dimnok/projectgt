...
@useResult
$Res call({
 String id,@JsonKey(name: 'company_id') String companyId,@JsonKey(name: 'contract_id') String contractId, String title, String number,@JsonKey(name: 'act_date') DateTime actDate,@JsonKey(name: 'period_from') DateTime periodFrom,@JsonKey(name: 'period_to') DateTime periodTo, double amount,@JsonKey(name: 'vat_amount') double vatAmount,@JsonKey(name: 'advance_retention') double advanceRetention,@JsonKey(name: 'warranty_retention') double warrantyRetention,@JsonKey(name: 'other_retentions') double otherRetentions,@JsonKey(name: 'total_to_pay') double totalToPay, String? note,@JsonKey(name: 'workflow_status') String workflowStatus,@JsonKey(name: 'payment_status') String paymentStatus,@JsonKey(name: 'created_at') DateTime? createdAt,@JsonKey(name: 'updated_at') DateTime? updatedAt,@JsonKey(name: 'created_by') String? createdBy
});
