-- Удаление поля required_date из заявок на закупку.
...
DROP FUNCTION IF EXISTS public.purchase_request_create_draft(UUID, UUID, DATE, TEXT);
DROP FUNCTION IF EXISTS public.purchase_request_update_header(UUID, UUID, DATE, TEXT);
...
REVOKE ALL ON FUNCTION public.purchase_request_create_draft(UUID, UUID, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.purchase_request_create_draft(UUID, UUID, TEXT) TO authenticated;

REVOKE ALL ON FUNCTION public.purchase_request_update_header(UUID, UUID, TEXT) FROM PUBLIC;
GRANT EXECUTE ON FUNCTION public.purchase_request_update_header(UUID, UUID, TEXT) TO authenticated;
