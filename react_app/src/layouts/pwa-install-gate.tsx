      ...
      <div className="flex w-full max-w-sm flex-col gap-5">
        ...
        <div className="flex flex-col gap-2">
          ...
          <p className="text-sm text-muted-foreground">
            На телефоне Стройка PRO открывается только после установки на экран
